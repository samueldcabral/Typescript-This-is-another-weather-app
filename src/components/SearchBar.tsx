  ...
  return (
    <div className="container">
      ...
      <div className="input-group mb-3">
        <input type="text" className="form-control" placeholder="Enter the name of the city" aria-label="Enter the name of the city" aria-describedby="button-addon2" onChange={(event) => handleChange(event)} onKeyDown={(event) => handleKeyDown(event)}/>
